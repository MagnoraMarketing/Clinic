...
export function Logo({ href = "/", sub = true }: { href?: string; sub?: boolean }) {
  return (
    <Link href={href} className="flex shrink-0 items-center gap-2.5 whitespace-nowrap" aria-label="AIbooking Clinic – home">
      ...
      <span className="leading-none">
        ...
        {sub && <span className="mt-0.5 block text-[10.5px] font-medium tracking-wide text-ink-400">AI receptionist for clinics</span>}
      </span>
    </Link>
  );
}
